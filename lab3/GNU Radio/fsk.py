...
class fsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Transmisor FSK", catch_exceptions=True)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 300000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_b(samp_rate, analog.GR_SQR_WAVE, 10000, 1, 0, 0)
